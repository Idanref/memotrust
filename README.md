...
<div align="center">
<img src="assets/how-it-works.png" alt="Flow: an agent proposes a memory, it is quarantined, memotrust judges the evidence and records a receipt, and only trusted memory is recalled. A 60-day decay or a human dispute sends it back to withheld." width="900" />
</div>
